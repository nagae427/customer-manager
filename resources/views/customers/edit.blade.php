...
<div class="card create-edit-container">
    <form action="{{ route('customers.update_confirm', $customer) }}" method="POST">
        @csrf
        <div class="form-items">
            <div class="form-item">
                <label for="customer_name">顧客名<span>*</span></label><br>
                <input type="text" id="customer_name" name="customer_name" maxlength="50" required placeholder="例: 株式会社ABC" value="{{ old('customer_name', $customer->customer_name) }}">
            </div>
            <div class="form-item">
                <label for="customer_name_kana">顧客名(かな)<span>*</span></label><br>
                <input type="text" id="customer_name_kana" name="customer_name_kana" maxlength="100" required placeholder="例: かぶしきがいしゃえーびーしー" value="{{ old('customer_name_kana', $customer->customer_name_kana) }}">
            </div>
        </div>
        ...
        <div class="form-items">
            <div class="form-item">
                ...
                <input type="text" id="postal_code" name="postal_code" maxlength="8" placeholder="例: 123-4567" value="{{ old('postal_code', $customer->postal_code) }}">
            </div>
        ...
        <div class="form-item">
            ...
            <input type="text" id="address" name="address" maxlength="255" placeholder="例: 東京都千代田区千代田1-1-1" value="{{ old('address', $customer->address) }}">
        </div>

        <div class="form-items">
            <div class="form-item">
                <label for="contact_person_name">担当者名<span>*</span></label><br>
                <input type="text" id="contact_person_name" name="contact_person_name" maxlength="30" required placeholder="例: 山田 太郎" value="{{ old('contact_person_name', $customer->contact_person_name) }}">
            </div>
        ...
        <div class="form-items">
            <div class="form-item">
                ...
                <input type="text" id="contact_person_tel" name="contact_person_tel" maxlength="20" placeholder="例: 090-1234-5678" required value="{{ old('contact_person_tel', $customer->contact_person_tel) }}"> 
            </div>
